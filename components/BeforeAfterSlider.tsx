...
const pillClass =
  'pointer-events-none absolute bottom-3 flex h-8 items-center rounded-full border-2 border-fg bg-paper px-3 text-xs font-medium text-fg shadow-[2px_2px_0_rgba(53, 97, 125, 0.35)]'
      ...
      >
        ...
        */}
        ...
        >
          ...
          {/* Drag handle */}
          <div className="absolute left-1/2 top-1/2 flex h-10 w-10 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border-2 border-fg bg-paper text-fg shadow-[2px_2px_0_rgba(53, 97, 125, 0.35)]">
