...
export default function CaseCarousel({ images: imagesProp, aspect = '16/9', caption }: CarouselProps) {
  ...
  const btnClass = 'flex items-center justify-center rounded-full border-2 border-fg bg-paper text-fg shadow-[2px_2px_0_rgba(130,83,26,0.35)] transition hover:bg-accent focus:outline-none focus-visible:ring-2 focus-visible:ring-accent/40'
