...
export default function CaseCarousel({ images, aspect = '16/9', caption }: CarouselProps) {
  ...
  return (
    <figure className="my-10 space-y-4">
      ...
      >
        <div className="pointer-events-none absolute right-3 top-3 z-20 inline-flex items-center rounded-full border border-white/45 bg-white/80 p-1.5 text-fg/75 shadow-sm backdrop-blur">
