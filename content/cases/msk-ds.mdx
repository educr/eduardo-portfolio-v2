...
In 2021, MSK's products were siloed and diverged in front-end solutions, with the effect of visual inconsistencies across the board.

<Carousel
  images={[
    {
      src: '/cases/msk-ds/audit-1.png',
      alt: ''
    },
    {
      src: '/cases/msk-ds/audit-2.png',
      alt: ''
    },
    {
      src: '/cases/msk-ds/audit-3.png',
      alt: ''
    }
  ]}
  caption="Audit of MSK's products, channels, and artifacts"
/>
