...
<figure>
  <img src="/cases/msk-ds/colors.png" alt="Color scales in a color tool" />
  <figcaption>A color tool displaying our color scales with contrast ratios</figcaption>
</figure>
...
The DS was adopted across multiple product teams with varying applications across the organization. 

<div className="mt-10 rounded-3xl bg-paper px-6 py-8" style={{border: '3px solid #351F57', boxShadow: '5px 5px 0 rgba(130, 83, 26, 0.35)'}}>
