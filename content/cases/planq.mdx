...
<Carousel
  images='[{"src":"/cases/planq/workshop.jpg","alt":""},{"src":"/cases/planq/workshop-board.png","alt":""}]'
...
<Carousel
  images='[{"src":"/cases/planq/audit-1.png","alt":""},{"src":"/cases/planq/audit-2.png","alt":""},{"src":"/cases/planq/audit-3.png","alt":""},{"src":"/cases/planq/audit-4.png","alt":""}]'
  caption="Auditing original tool layouts for consistency and hierarchy"
/>
...
I owned the notificatians feature and worked closely with existing users through regular discussions to understand what sorts of notifications would be of value to them. 

<Carousel
  images='[{"src":"/cases/planq/notification-1.png","alt":""},{"src":"/cases/planq/notification-2.png","alt":""},{"src":"/cases/planq/notification-3.png","alt":""}]'
...
<Carousel
  images='[{"src":"/cases/planq/observation-1.jpg","alt":""},{"src":"/cases/planq/observation-2.jpg","alt":""},{"src":"/cases/planq/observation-3.jpg","alt":""},{"src":"/cases/planq/observation-4.jpg","alt":""},{"src":"/cases/planq/observation-5.jpg","alt":""},{"src":"/cases/planq/observation-6.jpg","alt":""}]'
...
Partnering with therapists, we mapped data priorities across workflow stages. In parallel, we collaborated with developers to ensure **integration feasibility** with existing APIs. I took charge of the dashboard while the design lead worked on the patient details page.

I created prototypes which we tested **interactive Figma flows** with real therapists to validate clarity, data comprehension, and trust in AI-assisted insights.
...
Although I left MSK before implementation, **user testing showed strong early validation**:
...
<div className="my-5 rounded-3xl p-8" style={{border: '3px solid #351F57', background: '#FFFFFF', boxShadow: '5px 5px 0 rgba(130, 83, 26, 0.35)'}}>
  <blockquote className="text-xl font-semibold leading-relaxed text-fg">
    “I was skeptical at first, but after using it, I can see how this really helps us. It’s more useful — and more thoughtful — than I expected.”
     <br/> Radiation therapist
  </blockquote>
</div>

Since I've left, I've received some updates from the lead who is still at MSK:
- The notifications have gone live with Planners and Coordinators and "they love them". 
- The card view is going to be built for a new user group: Attending and Resident Physicians.
- The table view has gone through successful UAT with Radiation Therapists and they are already asking for more (a view for helping with their scheduling tasks).
