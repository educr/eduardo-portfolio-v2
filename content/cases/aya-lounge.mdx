...
My work focused on streamlining a complex, multi-step registration flow — from disparate forms and separate logins to a unified in-app process — while ensuring compliance with age, identity, and HIPAA constraints. 

Collaborating across design, legal, and engineering, we reduced friction and enabled patients to sign consent, create an account, and engage in the community all within the app.
